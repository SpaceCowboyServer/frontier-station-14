...
round-end-system-shuttle-auto-called-announcement = Був відправлений автоматичний шатл. ETA: {$time} {$units}. Відкликайте шатл, щоб продовжити зміну.
round-end-system-shuttle-recalled-announcement = Евакуаційний шатл відкликано.
round-end-system-round-restart-eta-announcement = Перезапуск раунду {$time} {$units}...
